        ...
        <div class="divide-y divide-gray-200">
            <div class="pb-3">
                <div class="flex rounded-lg shadow-sm ring-1 ring-gray-200 focus-within:ring-primary">
                    ...
                    <input type="text" class="w-full px-3 py-1.5 ps-0 pe-3 text-base placeholder:text-gray-400 focus:outline-0 sm:text-sm sm:leading-6" placeholder="Cari merek">
                </div>
            </div>
                            ...
                            <?php while ($row = $result->fetch_assoc()) : ?>
                                <tr class="hover:bg-gray-50">
                                    <td class="p-0 first-of-type:ps-1 last-of-type:pe-1 sm:first-of-type:ps-3 sm:last-of-type:pe-3">
                                        <a href="edit.php?id=<?php echo $row['id_brands']; ?>">
                                            <div class="px-3 py-4">
                                    ...
                                    <td class="p-0 first-of-type:ps-1 last-of-type:pe-1 sm:first-of-type:ps-3 sm:last-of-type:pe-3">
                                        <a href="edit.php?id=<?php echo $row['id_brands']; ?>">
                                            <div class="px-3 py-4">
                                                <span class="text-sm leading-6 text-gray-950 dark:text-white font-medium"><?= $row['name']; ?></span>
                                            </div>
                                        </a>
                                    </td>
                                    <td class="flex p-0 first-of-type:ps-1 last-of-type:pe-1 sm:first-of-type:ps-3 sm:last-of-type:pe-3">
                                        <div class="flex items-center gap-x-2 whitespace-nowrap px-3 py-4">
                                            <a href="merek/edit.php?id_brands=<?php echo $row['id_brands']; ?>">
                                            ...
                                            <a href="merek/delete.php?id_brands=<?php echo $row['id_brands']; ?>" onclick="return confirm('Yakin ingin menghapus?');">
