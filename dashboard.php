...
<body>
    <div class="relative min-h-screen bg-[url('image/backgroud.png')] bg-center bg-cover">
        ...
        <!-- Konten Tengah -->
        <div class="absolute top-1/2 left-0 w-full px-10 transform -translate-y-1/2 flex items-center justify-between z-10">
        <!-- Teks di Kiri -->
        ...
        <div>
            <img src="image/mobil.png" alt="Mobil" class="h-80 w-auto">
        </div>
    </div>
    </div>
